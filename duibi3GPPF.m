...
fprintf('仿真完成。\n');
save('data_prop.mat', 't_span', 'test_errs', 'beta_record', 'b_s', 'b_f', 'a_ppc');
fprintf('手稿方法数据已保存至 data_prop.mat \n');
%% --- 3. 绘图部分  ---
...
title('Agent 1 Tracking Error under GPPF Control (Different Initial Errors)', 'Interpreter', 'latex');
